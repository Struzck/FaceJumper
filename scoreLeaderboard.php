...
<body>
    ...
    <?php
        ...
        if (isset($_REQUEST["page"])){
            $_SESSION["pagination"]["score"] = (int)$_REQUEST["page"];
        }

        if(isset($_SESSION["pagination"]["score"])) {
            $pagNum = $_SESSION["pagination"]["score"];
        } 
        ...
        $dataQuery = mysql_query("SELECT * FROM USERS ORDER BY user_record DESC LIMIT $start, 10");
    ?>
    ...
    <div class="col-sm-6 top-buffer" style="margin-left: 325px;">  
        ...
        <div class="container top-buffer" style="margin-left: 240px;">
            <ul class="pagination">
                ...
                ?>
                    <li><a href="scoreLeaderboard.php?page=<?php echo $pag ?>"><?php echo $pag?></a></li>
                <?php
                    }
                }
                ?></ul>
