...
<body>
    ...
    <?php
        ...
        if (isset($_REQUEST["page"])){
            $_SESSION["pagination"]["deaths"] = (int)$_REQUEST["page"];
        }

        if(isset($_SESSION["pagination"]["deaths"])) {
            $pagNum = $_SESSION["pagination"]["deaths"];
        } 
        ...
        $dataQuery = mysql_query("SELECT * FROM USERS ORDER BY user_deaths DESC LIMIT $start, 10");
    ?>
    ...
    <div class="col-sm-6 top-buffer" style="margin-left: 325px;">  
        ...
        <div class="container top-buffer" style="margin-left: 240px;">
            <ul class="pagination">
                ...
                ?>
                    <li><a href="deathsLeaderboard.php?page=<?php echo $pag ?>"><?php echo $pag?></a></li>
                <?php
                    }
                }
                ?></ul>
